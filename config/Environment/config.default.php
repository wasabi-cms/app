 ...
 * Server timezone
 *
 * //@TODO: ask in command line installer
 */
 ...
 * from "app/config/Environment/environment.local.php" will be applied.
 */
...
$configure = [
    ...
    'App' => [
        ...
        'cachePrefix' => '___CACHE_PREFIX___'
    ],
    ...
    'Datasources' => [
        'default' => [
            ...
            //'init' => ['SET GLOBAL innodb_stats_on_metadata = 0'], // boost for MySQL < 5.6
            'url' => null,
        ],
    ...
    'Session' => [
        'defaults' => 'php',
        'cookie' => '___SESSION_NAME___',
    ],

    /**
     * The Cookie name.
     */
    'Cookie.name' => '___COOKIE_NAME___',

    /**
     * A random string used in security hashing methods.
     */
    'Security.salt' => '___SALT___'
];
